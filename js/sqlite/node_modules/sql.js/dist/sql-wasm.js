    ...
    initSqlJsPromise = new Promise(function(resolveModule, reject) {
        ...
        e.onRuntimeInitialized = function() {
                    ...
                    if (h) {
                        if ("string" === typeof h) {
                            for (var q = Array(h.length), B =
                                    0, ha = h.length; B < ha; ++B) q[B] = h.charCodeAt(B);
                            h = q
                        }
                        ea(p, l | 146);
                        q = u(p, "w");
            ...
            var d = y(4),
                ...
                v = f("sqlite3_prepare_v2", "number", ["number", "string", "number", "number",
                    "number"
                ]),
                ...
                rc = f("sqlite3_bind_parameter_index",
                ...
                Bc =
                f("sqlite3_column_name", "string", ["number", "number"]),
                ...
                try {
                    ...
                    for (h = []; 0 !== x(D, "i8");) {
                        ...
                        if (0 !== ja) {
                            ...
                            // 更改撈資料的形式 20210304 by Nicholastuan
                            for (null != l && q.bind(l); q.step();) null === B , h.push(q.getAsObject());
            ...
            c.prototype.prepare = function(h,
                l) {
                pa(d);
            ...
            c.prototype.close = function() {
                null !==
                    this.db && (Object.values(this.fb).forEach(function(h) {
                        h.free()
                ...
                var p = va(function(q, B, ha) {
                    ...
                    switch (typeof D) {
                        ...
                        case "string":
                            ...
                            break;
                        case "object":
                            null === D ? qb(q) : null != D.length ? (B = ma(D), Nc(q, B, D.length, -1), na(B)) : rb(q, "Wrong API use : tried to return a value of an unknown type (" +
                                D + ").", -1);
                            break;
                        default:
                            qb(q)
        ...
        var I = "",
            Ba, Ca, Da, Fa;
        if (za) I = G ? require("path").dirname(I) + "/" : __dirname + "/", Ba = function(a, b) {
            Da || (Da = require("fs"));
            Fa || (Fa = require("path"));
            a = Fa.normalize(a);
            ...
            assert(a.buffer);
            return a
        }, 1 < process.argv.length && (xa = process.argv[1].replace(/\\/g, "/")), process.argv.slice(2), "undefined" !== typeof module && (module.exports = e), e.inspect = function() {
        ...
        else if (ya || G) G ? I = self.location.href : document.currentScript && (I = document.currentScript.src), I = 0 !== I.indexOf("blob:") ? I.substr(0, I.lastIndexOf("/") + 1) : "", Ba = function(a) {
                ...
                Na: {
                    ...
                    rename: function(a, b, c) {
                        if (Q(a.mode)) {
                            ...
                            if (d)
                                for (var f in d.Ma) throw new O(55);
                        }
        ...
        function u(a, b, c, d) {
            ...
            if (!f && (c = g ? 40960 === (g.mode & 61440) ? 32 : Q(g.mode) &&
                    ("r" !== $b(b) || b & 512) ? 31 : Xb(g, $b(b)) : 44)) throw new O(c);
            b & 512 && mc(g, 0);
            b &= -131713;
            d = dc({
                node: g,
        ...
        var id = {
            ...
            m: function(a, b, c, d, f) {
                try {
                    ...
                    Qc(g, a, d);
                    M = [g.position >>>
                        0, (N = g.position, 1 <= +Math.abs(N) ? 0 < N ? (Math.min(+Math.floor(N / 4294967296), 4294967295) | 0) >>> 0 : ~~+Math.ceil((N - +(~~N >>> 0)) / 4294967296) >>> 0 : 0)
                    ];
                    L[f >> 2] = M[0];
                    L[f + 4 >> 2] = M[1];
        ...
        function ld() {
            ...
            if (!(0 < eb)) {
                if (e.preRun)
                    for ("function" == typeof e.preRun && (e.preRun = [e.preRun]); e.preRun.length;) db();
                nb($a);
